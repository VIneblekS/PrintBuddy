...
<html>
	...
	<body id = "body" class = "flex flex-col gap-5 sm:gap-6 pb-24">
		...
		<div class = "flex flex-col justify-center items-center gap-8 sm:gap-10">
			...
			<div class = "flex justify-between items-center w-80 sm:w-105 md:w-120 lg:w-135">
				<button id="submit" class = "w-40 h-10 items-center flex justify-center text-sm bg-primaryColor rounded-lg font-normal text-white shadow-md shadow-black/40">Adaugă cursul</button>
				<button id="newSection" class = "w-10 h-10 font-medium text-3xl text-primaryColor border border-primaryColor rounded-full flex items-center justify-center">+</button>
			</div>
