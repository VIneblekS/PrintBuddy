...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Bambu Lab A1</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="BambuLabA1/BambuLabA1Photo">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Noul AMS Lite este elegant și fiabil, făc&acirc;nd imprimarea 3D multicoloră accesibilă tuturor.
A1 revoluționează controlul fluxului &icirc;n imprimarea 3D. Utilizează un senzor de curenți turbionari de &icirc;naltă rezoluție și frecvență &icirc;naltă pentru a măsura presiunea din duză. Algoritmul nostru compensează &icirc;n mod activ debitul &icirc;n funcție de citirile pentru a extruda cu precizie.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="167" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/uTKkxl8y-BI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="BambuLabA1/BambuLabA1Manual"></iframe>
				</div>
			</div>
		</div>
	</div>
