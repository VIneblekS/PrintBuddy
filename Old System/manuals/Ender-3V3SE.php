...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Ender-3 V3 SE</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Ender-3V3SE/Ender-3V3SEPhoto">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Nivelarea este baza calității imprimării. Ender-3 V3 SE dispune de un senzor CR Touch pentru nivelare automată și un senzor de deformare pentru compensarea axei Z automată. Nu este nevoie să rotiți șuruburi sau să trageți o h&acirc;rtie. Atingeți &bdquo;Extrude&rdquo; și filamentul
va curge lin din duză. Atingeți &bdquo;Retrage&rdquo;, iar filamentul va ieși rapid astfel inlocuirea filamentului devine mult mai usoara.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="163" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/5rDXyJhW_K0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Ender-3V3SE/Ender-3V3SEManual"></iframe>
				</div>
			</div>
		</div>
	</div>
