...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Ender-3 V2 Neo</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Ender-3V2Neo/Ender-3V2NeoPhoto">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Design integrat complet metalic cu un portal robust pentru imprimare stabilă. Suprafața netedă a portalului arată mai simplă și mai estetică.  Nivelarea automată CR Touch completează verificarea &icirc;nălțimii de imprimare &icirc;n 16 puncte pe suprafața de construcție, asigur&acirc;nd acuratețea nivelării și &icirc;mbunătățind calitatea imprimării. Placa de construcție magnetică din oțel cu arc din PC are o aderență bună și permite &icirc;ndepărtarea rapidă a imprimării cu doar o ușoară &icirc;ndoire. Placa de bază silențioasă permite funcționarea cu decibeli mici, fără a deranja studiul sau somnul.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="166" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/vaDvZqpQ_t8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Ender-3V2Neo/Ender-3V2NeoManual"></iframe>
				</div>
			</div>
		</div>
	</div>
