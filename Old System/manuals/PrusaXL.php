...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Prusa XL</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="PrusaXL/PrusaXLPhoto">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Prusa MK4 are 7 kg si 500&times;550&times;400 mm, vine cu piese din plastic reproiectate, mai robuste și noi motoare precise de 0,9&deg; pe axele X și Y care ajută la eliminarea artefactelor fine verticale de pe imprimări. Aceasta impriamnta este pe deplin compatibila cu o gamă largă de materiale. Indiferent dacă doriți să imprimați ceva pentru distracție din PLA și materiale flexibile, sau dacă aveți nevoie să produceți prototipuri durabile din PETG, ASA, policarbonat și polipropilenă - Prusa MK4 le poate printa fără nicio problemă.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="158" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/jq2_O_Tw2vI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="PrusaXL/PrusaXLManual"></iframe>
				</div>
			</div>
		</div>
	</div>
