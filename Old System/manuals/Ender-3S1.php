...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Ender-3 S1</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Ender-3S1/Ender-3S1Photo">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Ușor de utilizat și precis, cu nivelare automată &icirc;n 16 puncte, chiar și pentru primul strat. Preinstalarea și designul modular fac asamblarea simplă și ușoară. Șuruburile cu două axe Z și motoarele duble &icirc;mbunătățesc foarte mult calitatea imprimării. Funcție de reluare dublă: reluarea funcției de imprimare și a senzorului de filament sunt esențiale pentru a evita pierderea timpului și a filamentului. Ecranul cu butonul LCD de 4,3 inchi acceptă noua interacțiune cu interfața de utilizare și stingerea automată a luminii &icirc;n 5 minute.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="176" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/AghQEvW-4JQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Ender-3S1/Ender-3S1Manual"></iframe>
				</div>
			</div>
		</div>
	</div>
