...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Bambu Lab P1S</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="BambuLabP1S/BambuLabP1SPhoto">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Funcționează imediat din cutie. Nu trebuie să te &icirc;ncurci cu ea, pur și simplu apăsați pe print, iar imprimanta se va ocupa de toate calibrările (Auto-Bed Leveling, Compensare vibrații) pentru dvs. Bucurați-vă de imprimare fără probleme de fiecare dată cu P1S.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="169" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/8dIH4d47hao" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="BambuLabP1S/BambuLabP1SManual"></iframe>
				</div>
			</div>
		</div>
	</div>
