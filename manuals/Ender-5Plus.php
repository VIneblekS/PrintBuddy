...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Ender-5 Plus</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Ender-5Plus/Ender-5PlusPhoto">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">CR Touch preinstalat, măsoară cu precizie &icirc;nclinarea suprafeței patului, oferă compensarea automată pentru axa Z pentru denivelările plăcii platformei și oferă o funcționare fiabilă cu toate suprafețele de construcție.Cu un spațiu de imprimare de 350x350x400mm, modelele mari pot fi imprimate &icirc;ntr-un singur pas. Nu mai este nevoie de asamblare suplimentară cu modulele imprimate separat.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="181" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/-kKXXKGQzCo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Ender-5Plus/Ender-5PlusManual"></iframe>
				</div>
			</div>
		</div>
	</div>
