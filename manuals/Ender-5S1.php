...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Ender-5 S1</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Ender-5S1/Ender-5S1Photo">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Sistem de mișcare &icirc;mbunătățit pentru accelerație de 2000 mm/s&sup2; și viteză de imprimare de p&acirc;nă la 250 mm/s. Fiecare axă X/Y/Z este condusă de un motor de &icirc;naltă precizie. Un arbore de transmisie din oțel sincronizează cele două curele pe axa Y. Un cadru cub complet metalic se potrivește cu structura carteziană clasică. Stabilitatea este sporită de arbori liniari groși, ghișeuri suplimentare, două console și suporturi de pat din silicon. Aceasta imprimanta are capacitatea de a folosi filamente rezistente la caldura. Filamente obișnuite: PLA, PETG, TPU. Filamente de &icirc;naltă temperatură: ABS, PC, ASA, HIPS.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="165" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/Vqy_SNUnj7o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Ender-5S1/Ender-5S1Manual"></iframe>
				</div>
			</div>
		</div>
	</div>
