...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Bambu Lab X1-Carbon</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="BambuLabX1-Carbon/BambuLabX1-CarbonPhoto">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Bambu Lab X1-Carbon, echipat cu răcire suplimentară și o duză &icirc;ntărită și un angrenaj de antrenare, deblochează o selecție mai largă de materiale, inclusiv PA, PC, PET și TPU și este specializată &icirc;n fibre de carbon și polimeri armați cu fibră de sticlă.
Algoritmul de compensare activă a vibrațiilor (XY) și compensarea extrudării garantează un plus de netezime și vă oferă printuri bune.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="171" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/YJcjfINcA2I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="BambuLabX1-Carbon/BambuLabX1-CarbonManual"></iframe>
				</div>
			</div>
		</div>
	</div>
