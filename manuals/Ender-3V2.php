...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Ender-3 V2</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Ender-3V2/Ender-3V2Photo">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Design integrat integral din metal cu mișcare lină. Imprimare de calitate și de &icirc;naltă precizie. Placă de bază silențioasă auto-dezvoltată, bucurați-vă de imprimare fără sunet.Sprijină reluarea tipăririi și &icirc;nregistrează cu precizie datele de imprimare. Nu vă faceți griji pentru &icirc;ntreruperea bruscă a curentului. Sursa de alimentare de &icirc;naltă calitate este mult mai sigură și &icirc;ndeplinește cerințele de &icirc;ncălzire rapidă, precum și de imprimare de lungă durată. Ecran color HD de 4,3 inchi pentru o nouă interacțiune cu interfața de utilizare. Operare mai simplă, cu vedere bună și experiență de utilizare optimizată.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="177" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/gokN9xNG94U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Ender-3V2/Ender-3V2Manual"></iframe>
				</div>
			</div>
		</div>
	</div>
