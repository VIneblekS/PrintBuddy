...
<body class="flex-column m-top-40px gap-20px">
	...
	<div class="flex-column align-center gap-80px">
		<div>
			<h1 class="blue size30px">Prusa i3 MK3S+</h1>
		</div>
		<div class="w1200px flex-space-between align-center">
			<div class="img20">
				<img src="Prusai3MK3S+/Prusai3MK3S+Photo">
			</div>
			<div class="flex-column gap-24px w45per">
				<div class="w100per full-border r10px">
					<div class="flex-column gap-15px full-5per">
						...
						<p class="normal size20px">Prusa MK3S+ dispune de un ansamblu de extrudare din aluminiu pe axa Y. Datorită cadrului durabil, Prusa MK3S+ este stabila, rigida și ușor de asamblat. Ți-e teamă ca o &icirc;ntrerupere de curent o să &icirc;ți strice imprimarea de 48 de ore? Nu vă mai faceți griji MK3S+ poate face față acestor situatii! Imprimanta isi poate reveni complet dupa pierderea energiei și poate continua să imprime exact acolo unde a rămas. Acasta detectează &icirc;ntreruperile de alimentare și oprește &icirc;ncălzirea patului și a extruderului salvand ultima locație cunoscută.</p>
					</div>
				</div>
				<div class="flex-column gap-10px">
					...
					<form action = "../ratingSystemProcess/rating.php" method = 'POST' class="no-display">
						<button type="submit" name="rate" value="162" class="rate-button"></button>
					</form>
				</div>
			</div>
		</div>
		<div class="flex-column align-center gap-200px">	
			<div class="w1200px flex-column gap-80px align-center">
				...
				<div class="video-container w100per">
					<iframe width = "100%" height = "100%" src="https://www.youtube.com/embed/GE-lrRbU124" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
			<div class="w1200px flex-column gap-80px align-center bottom-150px">
				...
				<div class="pdf-container w100per">
					<iframe width = "100%" height = "100%" src="Prusai3MK3S+/Prusai3MK3S+Manual"></iframe>
				</div>
			</div>
		</div>
	</div>
